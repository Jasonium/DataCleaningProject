...
The variables are as follows.  All measurement variables were normalized by subtracting their mean and dividing by their range, and therefore are unitless and lie in the interval [-1,1].  To reiterate, the values reported in tidydata.txt are the **means of these normalized values** for the given subject and activity.
